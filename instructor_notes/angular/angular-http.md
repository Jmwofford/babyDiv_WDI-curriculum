...
In a [previous lesson](https://git.generalassemb.ly/atl-wdi/wdi-curriculum-10/blob/master/instructor_notes/unit_02/ajax/ajax-with-jQuery.md) you used AJAX calls to grab GIFs.
