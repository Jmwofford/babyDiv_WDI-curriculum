...
**Exercise:** (5m) 
Do the first two prompts in [student_starter](https://git.generalassemb.ly/atl-wdi/wdi-curriculum/tree/master/labs/jQuery/in-class-exercises)
...
**Exercise:** Do the next two prompts in [student_starter](https://git.generalassemb.ly/atl-wdi/wdi-curriculum/tree/master/labs/jQuery/in-class-exercises)
